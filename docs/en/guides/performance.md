...
> **Version**: 0.3.2 | **Related**: [Execution Guide](/docs/en/guides/execution.md), [Tracking Guide](/docs/en/guides/tracking.md)
...
- **[Tracking Guide](/docs/en/guides/tracking.md)** — Monitor pipeline metrics
- **[API Guide](/docs/en/guides/api.md)** — Build custom dashboards for performance
- **[Example: Dataflow Audio Pipeline](/docs/en/examples/dataflow-audio-pipeline.md)** — See optimization in action
