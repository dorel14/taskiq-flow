...
See [Tracking Guide](/docs/en/guides/tracking.md) for advanced monitoring.
...
See [Performance Guide](/docs/en/guides/performance.md) for detailed optimization strategies.
...
- **[Pipelines Guide](/docs/en/guides/pipelines.md)** — Choosing between pipeline types and patterns
- **[Tracking Guide](/docs/en/guides/tracking.md)** — Monitoring pipeline status and history
- **[Performance Guide](/docs/en/guides/performance.md)** — Tuning for speed and resource usage

---

*Understanding execution is key to building reliable pipelines. Next, learn about [Pipeline Types](/docs/en/guides/pipelines.md).*
