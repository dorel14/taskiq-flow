...
> **Version**: 0.3.2 | **Related**: [Tracking Guide](/docs/en/guides/tracking.md), [API Guide](/docs/en/guides/api.md)
...
Or use the built-in API health endpoint (/health) from [API Guide](/docs/en/guides/api.md).
...
- **[Tracking Guide](/docs/en/guides/tracking.md)** — Backend storage and historical queries
- **[API Guide](/docs/en/guides/api.md)** — REST endpoints for dashboard backends
- **[Examples: WebSocket Demo](/docs/en/examples/websocket-demo.md)** — Complete working code

---

*Stream live pipeline events. Combine with [Tracking Storage](/docs/en/guides/tracking.md) for persistent history.*
