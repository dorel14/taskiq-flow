...
> **Version**: 0.3.2 | **Related**: [Execution Guide](/docs/en/guides/execution.md), [WebSocket Guide](/docs/en/guides/websocket.md)
...
See [WebSocket Guide](/docs/en/guides/websocket.md) for complete setup.
...
Use the REST API endpoints (see [API Guide](/docs/en/guides/api.md)) to build custom dashboards:
...
- **[WebSocket Streaming](/docs/en/guides/websocket.md)** — Real-time event delivery for dashboards
- **[Scheduling](/docs/en/guides/scheduling.md)** — Automated recurring pipeline execution
- **[Performance Tuning](/docs/en/guides/performance.md)** — Optimize tracking overhead

---

*Track everything. Visualize with [WebSocket](/docs/en/guides/websocket.md).*
