...
> **Version**: 0.3.2 | **Related**: [Tracking Guide](/docs/en/guides/tracking.md), [WebSocket Guide](/docs/en/guides/websocket.md)
...
- **[WebSocket Guide](/docs/en/guides/websocket.md)** — Real-time event streaming for live updates
- **[Tracking Guide](/docs/en/guides/tracking.md)** — Historical execution data for analytics
- **[Example: API Server](/docs/en/examples/api-example.md)** — Complete working FastAPI app
