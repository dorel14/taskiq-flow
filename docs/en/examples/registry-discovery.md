...
1. **[Dataflow Guide](/docs/en/guides/pipelines.md#2-dataflow-pipeline)** — High-level usage
2. **[ExecutionEngine API](/docs/en/api/execution.md)** — Low-level execution control
3. **[DAGBuilder](/docs/en/api/execution.md#dagbuilder)** — Programmatic DAG construction
