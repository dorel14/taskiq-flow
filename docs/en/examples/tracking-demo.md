...
1. **[Tracking Guide](/docs/en/guides/tracking.md)** — Full tracking features (storage backends, metrics)
2. **[WebSocket Guide](/docs/en/guides/websocket.md)** — Real-time streaming of tracking events
3. **[API Guide](/docs/en/guides/api.md)** — Expose tracking data via REST API
