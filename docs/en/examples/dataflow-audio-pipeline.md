...
> **Version**: 0.3.2 | **File**: `examples/dataflow_audio_pipeline.py`
...
1. **[DataflowPipeline Guide](/docs/en/guides/pipelines.md#2-dataflow-pipeline)** — Deep dive into dataflow features
2. **[Execution Guide](/docs/en/guides/execution.md)** — Parallelism, timeouts, error handling
3. **[Performance Guide](/docs/en/guides/performance.md)** — Tuning `max_parallel`, resource profiles
