...
1. **[Dataflow Pipelines](/docs/en/guides/pipelines.md#2-dataflow-pipeline)** — Automatic DAG construction
2. **[Task Definition](/docs/en/guides/tasks.md)** — Advanced task features
3. **[Tracking](/docs/en/guides/tracking.md)** — Monitor pipeline execution
4. **[MapReduce](/docs/en/guides/execution.md#3-map-reduce-pattern)** — Batch processing pattern
