...
See the [Scheduling Guide](/docs/en/guides/scheduling.md) for full details on `PipelineScheduler`.
...
1. **[Scheduling Guide](/docs/en/guides/scheduling.md)** — Comprehensive cron and interval scheduling
2. **[PipelineScheduler](/docs/en/api/core.md#pipelinescheduler)** — API reference
3. **[Retry Guide](/docs/en/guides/retry.md)** — Handling failures in scheduled pipelines
