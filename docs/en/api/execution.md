...
- **[Tracking API](/docs/en/api/tracking.md)** — Monitor execution with PipelineTrackingManager
- **[WebSocket API](/docs/en/api/websocket.md)** — HookManager and event system
- **[Core API](/docs/en/api/core.md)** — Pipeline and middleware reference
