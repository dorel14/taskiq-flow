...
> **Version** : 0.3.2 | **Lié** : [Guide d'Exécution](/docs/fr/guides/execution.md), [Guide des Tâches](/docs/fr/guides/tasks.md)
...
Voir [Guide de Suivi](/docs/fr/guides/tracking.md) pour plus de détails.
...
Voir [Guide WebSocket](/docs/fr/guides/websocket.md).
...
Voir [Guide de Retry](/docs/fr/guides/retry.md).
...
Voir [steps/condition.py](../taskiq_flow/steps/condition.py) pour `IfStep`.
...
- **[Guide d'Exécution](/docs/fr/guides/execution.md)** — Comment les pipelines s'exécutent, gestion d'erreurs, timeouts
- **[Guide des Tâches](/docs/fr/guides/tasks.md)** — Écriture des fonctions de tâche et décorateurs
- **[Exemples](/docs/fr/examples/)** — Démonstrations complètes de pipelines

---

*Maîtriser les pipelines pour orchestrer n'importe quel workflow. Ensuite, apprendre sur la [Définition des Tâches](/docs/fr/guides/tasks.md).*
