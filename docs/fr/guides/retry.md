...
> **Version** : 0.3.2 | **Lié** : [Guide d'Exécution](/docs/fr/guides/execution.md), [Guide d'Ordonnancement](/docs/fr/guides/scheduling.md)
...
- **[Guide de Performance](/docs/fr/guides/performance.md)** — Optimiser l'exécution et l'usage des ressources
- **[Guide d'Ordonnancement](/docs/fr/guides/scheduling.md)** — Ordonnancement automatique des pipelines
- **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Surveiller les métriques de retry en production
