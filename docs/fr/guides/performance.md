...
- **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Surveiller les métriques des pipelines
- **[Guide API](/docs/fr/guides/api.md)** — Construire des tableaux de bord pour la performance
- **[Exemple : Pipeline Audio Dataflow](/docs/fr/examples/dataflow-audio-pipeline.md)** — Voir l'optimisation en action
