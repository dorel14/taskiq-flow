...
> **Version**: 1.0.0 | **Lié**: [Guide de Suivi](/docs/fr/guides/tracking.md), [Guide API](/docs/fr/guides/api.md)
...
Ou utiliser l'endpoint health intégré (/health) depuis le [Guide API](/docs/fr/guides/api.md).
...
- **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Backend de stockage et requêtes historiques
- **[Guide API](/docs/fr/guides/api.md)** — Endpoints REST pour backends de tableau de bord
- **[Exemples: Démo WebSocket](/docs/fr/examples/websocket-demo.md)** — Code complet fonctionnel

---

*Streamer les événements de pipeline en direct. Combiner avec [Stockage de Suivi](/docs/fr/guides/tracking.md) pour historique persistant.*
