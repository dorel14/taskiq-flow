...
> **Version** : 0.3.2 | **Lié** : [Guide d'Exécution](/docs/fr/guides/execution.md), [Guide WebSocket](/docs/fr/guides/websocket.md)
...
Voir [Guide WebSocket](/docs/fr/guides/websocket.md) pour la configuration complète。
...
Utiliser les endpoints API REST (voir [Guide API](/docs/fr/guides/api.md)) pour construire des tableaux de bord personnalisés:
...
- **[Streaming WebSocket](/docs/fr/guides/websocket.md)** — Livraison d'événements en direct pour tableaux de bord
- **[Planification](/docs/fr/guides/scheduling.md)** — Exécution périodique automatique de pipelines
- **[Performance](/docs/fr/guides/performance.md)** — Optimiser la surcharge de suivi

---

*Tout suivre. Visualiser avec [WebSocket](/docs/fr/guides/websocket.md).*
