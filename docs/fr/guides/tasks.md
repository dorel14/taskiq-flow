...
> **Version** : 0.3.2 | **Lié** : [Guide des Pipelines](/docs/fr/guides/pipelines.md), [Guide d'Exécution](/docs/fr/guides/execution.md)
...
Les stratégies de retry détaillées sont couvertes dans le [Guide des Retentatives](/docs/fr/guides/retry.md).
...
- **[Types de Pipelines](/docs/fr/guides/pipelines.md)** — Construire des workflows avec des tâches
- **[Guide d'Exécution](/docs/fr/guides/execution.md)** — Exécuter les pipelines et gérer les résultats
- **[Guide des Retentatives](/docs/fr/guides/retry.md)** — Stratégies robustes de récupération d'erreurs

---

*Les tâches sont vos atomes de workflow. Apprenez à les composer dans [Pipelines](/docs/fr/guides/pipelines.md).*
