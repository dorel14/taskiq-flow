...
> **Version** : 0.3.2 | **Lié** : [Guide de Suivi](/docs/fr/guides/tracking.md), [Guide WebSocket](/docs/fr/guides/websocket.md)
...
- **[Guide WebSocket](/docs/fr/guides/websocket.md)** — Streaming d'événements en temps réel pour mises à jour live
- **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Données historiques d'exécution pour analytics
- **[Exemple: Serveur API](/docs/fr/examples/api-example.md)** — App FastAPI complète fonctionnelle
