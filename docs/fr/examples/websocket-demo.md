...
1. **[Guide WebSocket](/docs/fr/guides/websocket.md)** — Configuration WebSocket complète, filtrage, déploiement production
2. **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Stockage historique données alongside événements temps réel
3. **[Guide API](/docs/fr/guides/api.md)** — Exposer via REST pour clients non-WebSocket
