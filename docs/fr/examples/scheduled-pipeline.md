...
Voir [Guide de Planification](/docs/fr/guides/scheduling.md) pour détails complets sur `PipelineScheduler`.
...
1. **[Guide de Planification](/docs/fr/guides/scheduling.md)** — Planification cron et intervalle complète
2. **[PipelineScheduler API](/docs/fr/api/core.md#pipelinescheduler)** — Référence API
3. **[Guide de Retry](/docs/fr/guides/retry.md)** — Gestion échecs pipelines planifiés
