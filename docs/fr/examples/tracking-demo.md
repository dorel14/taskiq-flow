...
1. **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Fonctionnalités complètes tracking (backends stockage, métriques)
2. **[Guide WebSocket](/docs/fr/guides/websocket.md)** — Streaming temps réel événements de tracking
3. **[Guide API](/docs/fr/guides/api.md)** — Exposer données tracking via REST API
