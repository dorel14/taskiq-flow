...
1. **[Pipelines Dataflow](/docs/fr/guides/pipelines.md#2-pipeline-dataflow)** — Construction automatique de DAG
2. **[Définition des Tâches](/docs/fr/guides/tasks.md)** — Fonctionnalités avancées de tâches
3. **[Suivi](/docs/fr/guides/tracking.md)** — Monitor exécutions de pipeline
4. **[MapReduce](/docs/fr/guides/execution.md#3-motif-map-reduce)** — Motif de traitement par lots
