...
1. **[Guide API](/docs/fr/guides/api.md)** — Documentation complète endpoints REST et meilleures pratiques
2. **[Guide WebSocket](/docs/fr/guides/websocket.md)** — Ajouter mises à jour temps réel à votre API
3. **[Guide de Suivi](/docs/fr/guides/tracking.md)** — Stocker historique exécution pour analytics
