...
1. **[Guide DataflowPipeline](/docs/fr/guides/pipelines.md#2-pipeline-dataflow)** — Plongée profonde fonctionnalités dataflow
2. **[Guide d'Exécution](/docs/fr/guides/execution.md)** — Parallélisme, timeouts, gestion erreurs
3. **[Guide de Performance](/docs/fr/guides/performance.md)** — Réglage `max_parallel`, profils ressources
