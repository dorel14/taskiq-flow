...
1. **[Guide Dataflow](/docs/fr/guides/pipelines.md#2-dataflow-pipeline)** — Utilisation haut niveau
2. **[API ExecutionEngine](/docs/fr/api/execution.md)** — Contrôle d'exécution bas niveau
3. **[DAGBuilder](/docs/fr/api/execution.md#dagbuilder)** — Construction programmatique de DAG
