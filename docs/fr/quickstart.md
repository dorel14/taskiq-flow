...
| Sujet | Guide |
|-------|-------|
| Pipelines séquentiels et dataflow | [Guide des Pipelines](/docs/fr/guides/pipelines.md) |
| Définitions de tâches et décorateurs | [Guide des Tâches](/docs/fr/guides/tasks.md) |
| Modes d'exécution et gestion d'erreurs | [Guide d'Exécution](/docs/fr/guides/execution.md) |
| Monitoring en temps réel | [Guide de Suivi](/docs/fr/guides/tracking.md) |
| Tableaux de bord en direct | [Guide WebSocket](/docs/fr/guides/websocket.md) |
| Planification cron | [Guide de Planification](/docs/fr/guides/scheduling.md) |
| Récupération d'erreurs | [Guide de Retry](/docs/fr/guides/retry.md) |
| Optimisation des performances | [Guide de Performance](/docs/fr/guides/performance.md) |
| Intégration API REST | [Guide API](/docs/fr/guides/api.md) |
| Référence API complète | [Référence API](/docs/fr/api/) |
...
- **[Référence API Complète](/docs/fr/api/)** — Documentation complète des classes et méthodes
- **[Galerie d'Exemples](/docs/fr/examples/)** — Explications détaillées de chaque script d'exemple
- **[README du Projet](../README.fr.md)** — Vue d'ensemble, installation et philosophie

---

*Prêt à approfondir ? Continuez avec le [Guide des Pipelines](/docs/fr/guides/pipelines.md).*
