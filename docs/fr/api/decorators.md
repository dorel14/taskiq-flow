...
*Pour API tâches complète, voir [Guide des Tâches](/docs/fr/guides/tasks.md). Pour écrire décorateurs personnalisés, étendre `BaseTaskDecorator` depuis `taskiq_flow.decorators`.*
