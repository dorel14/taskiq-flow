...
- **[API Suivi](/docs/fr/api/tracking.md)** — Surveiller l'exécution avec PipelineTrackingManager
- **[API WebSocket](/docs/fr/api/websocket.md)** — HookManager et système d'événements
- **[API Core](/docs/fr/api/core.md)** — Référence Pipeline et middleware
