...
Changements cassants notés dans [CHANGELOG.md](../CHANGELOG.md).

---

*Pour exemples détaillés, voir section [Exemples](/docs/fr/examples/). Pour doc méthode par méthode, se référer aux docstrings Python inline (`help(Pipeline)`).*
