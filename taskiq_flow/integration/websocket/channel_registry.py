...
class ChannelRegistry:
    ...
    def __init__(self) -> None:
        ...
        self._pattern_subscriptions: list[tuple[str, WebSocket]] = []
    ...
    async def subscribe_pattern(self, pattern: str, websocket: WebSocket) -> None:
    ...
    async def unsubscribe_pattern(self, pattern: str, websocket: WebSocket) -> None:
