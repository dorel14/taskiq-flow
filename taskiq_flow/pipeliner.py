...
class Pipeline(Generic[_FuncParams, _ReturnType]):
    ...
    def group(
        ...
        **additional_kwargs: Any,
        ...
        """
        Add a group step that executes multiple tasks in parallel.

        This step runs multiple independent tasks concurrently and collects
        all their results into a list.

        :param tasks: List of tasks to execute in parallel.
        :param param_names: Optional list of parameter names for each task.
                           If None, no parameters are passed to tasks.
        :param additional_kwargs: Additional kwargs to pass to tasks.
        :return: Pipeline with group step.
        """
        self.steps.append(
            DumpedStep(
